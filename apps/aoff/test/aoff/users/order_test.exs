defmodule AOFF.Users.OrderTest do
  ...
  describe "orders" do
    ...
    test "update_order/2 with invalid data returns error changeset", %{user: user} do
      ...
      assert order.id == Users.get_order!("public", order.id).id
    end
