defmodule AOFF.PageTest do
  ...
  describe "page" do
    test "get_page!/2 returns a single page" do
      ...
      assert Content.get_page!("public", category.title, page.title).id == page.id
    end

    test "create_page/1 with valid data creates a page" do
      category = category_fixture()
      attrs = create_page_attrs(%{"category_id" => category.id})
      assert {:ok, %Page{} = page} = Content.create_page("public", attrs)
    ...
    test "update_page/2 with invalid data returns error changeset" do
      ...
      assert page.title == Content.get_page!("public", category.title, page.title).title
    end
    ...
    test "delete_page/1 deletes the page" do
      ...
      assert Content.get_page!("public", category.title, page.title) == nil
    end
