defmodule AOFFWeb.Users.UnsubscribeToNewsControllerTest do
  ...
  describe "as a member" do
    ...
    test "show/1 unscribe the user to the news letter when the token is valid", %{conn: conn, user: user} do
      conn = get(conn, Routes.unsubscribe_to_news_path(conn, :show, user.unsubscribe_to_news_token))
