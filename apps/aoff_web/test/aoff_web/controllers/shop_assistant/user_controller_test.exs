defmodule AOFFWeb.ShopAssistant.UserControllerTest do
  ...
  describe "shop assistant" do
    ...
    test "lists all users", %{conn: conn} do
      conn = get(conn, Routes.shop_assistant_user_path(conn, :index))
      assert html_response(conn, 200) =~ gettext("Select User")
    end
