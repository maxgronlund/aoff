defmodule AOFFWeb.Content.CalendarController do
  ...
  def show(conn, %{"id" => id}) do
    prefix = conn.assigns.prefix
    case Content.get_page!("Calendar", id, prefix) do
      nil ->
        conn
      ...
      page ->
        participants = Events.list_participants(:all, page.id, prefix)
